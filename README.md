...
- Also, a disabled keybind function is added to disable the keybinds for the player.


Ping features

- Showdium adds a location ping system to the game that can be used to ping a location to the server that will be send to other Showdium users, with an colour and playerhead
